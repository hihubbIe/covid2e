					...
					<div class="col-12 col-md-9 col-lg-7 col-xl-6">
						<div class="card" style="border-radius: 15px; margin-top: 5em;">
							<div class="card-body p-5">
								<h2 class="text-uppercase text-center mb-5">Modifier l'activité : <%out.println(acti.getName());%></h2>
								
								    
				                 <%
					    			String testsuccess = request.getParameter("success");
					                if (testsuccess != null && testsuccess != ""){
					                	out.println("<div style='color:green;'> Activité modifiée ! </div>");
					                }
					                
					            	String testechec = request.getParameter("echec");
					                if (testechec != null && testechec != ""){
					                	out.println("<div style='color:red;'> L'activité n'a pas pu être modifiée ! </div>");
					                }
								%>	
