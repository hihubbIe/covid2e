        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;margin-top:5em;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Création d'un lieu</h2>
                ...
                <label class="form-label">Numéro</label>
                  <input type="number" class="form-control form-control-lg" name="numero" />
                </div>

                <div class="form-outline mb-4">
                 <label class="form-label">Rue</label>
                  <input type="text" class="form-control form-control-lg" name="rue" />
                </div>

                <div class="form-outline mb-4">
                <label class="form-label">Code Postal</label>
                  <input type="text" class="form-control form-control-lg" name="postal"/>
                </div>
			    ...
			    <select class="form-control" id="rien" name="pays">
			    	<% PaysDAO.getInstance();
                ...
                <br>
                <div class="d-flex justify-content-center">
                  <button type="submit" formaction="index.jsp"  class="btn btn-danger btn-block btn-lg gradient-custom-4 text-body">Annuler</button>
                </div>
